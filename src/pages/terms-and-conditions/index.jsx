	...
	render() {
		return (
			<Layout footer="true">
				...
				<TCP className="hasFooter" bg="#3C3459">
					<h1>Terms And Conditions</h1>
					<div>
						<h3>Introduction</h3>
						<p>
							These Website Standard Terms And Conditions (these “Terms” or these “Website Standard Terms
							And Conditions”) contained herein on this webpage, shall govern your use of this website,
							including all pages within this website (collectively referred to herein below as this
					...
					<div>
						...
						<p>
							...
							Terms, WebCap Studio and/or its licensors own all rights to the intellectual property and
					...
					<div>
						...
						<p>
							Certain areas of this Website are restricted from access by you and WebCap Studio may
					...
					<div>
						...
						<p>
							...
							Content, by displaying it, you grant WebCap Studio a non-exclusive, worldwide, irrevocable,
							royalty-free, sublicensable license to use, reproduce, adapt, publish, translate and
							distribute it in any and all media.
						</p>
						<p>
							Your Content must be your own and must not be infringing on any third party’s rights. WebCap
							Studio reserves the right to remove any of Your Content from this Website at any time, and
					...
					<div>
						<h3>No warranties</h3>
						<p>
							This Website is provided “as is,” with all faults, and WebCap Studio makes no express or
					...
					<div>
						...
						<p>
							In no event shall WebCap Studio, nor any of its officers, directors and employees, be liable
							to you for anything arising out of or in any way connected with your use of this Website,
							whether such liability is under contract, tort or otherwise, and WebCap Studio, including
							its officers, directors and employees shall not be liable for any indirect, consequential or
					...
					<div>
						...
						<p>
							You hereby indemnify to the fullest extent WebCap Studio from and against any and all
							liabilities, costs, demands, causes of action, damages and expenses (including reasonable
							attorney’s fees) arising out of or in any way related to your breach of any of the
					...
					<div>
						...
						<p>
							WebCap Studio is permitted to revise these Terms at any time as it sees fit, and by using
					...
					<div>
						<h3>Assignment</h3>
						<p>
							WebCap Studio shall be permitted to assign, transfer, and subcontract its rights and/or
					...
					<div>
						...
						<p>
							...
							constitute the entire agreement between WebCap Studio and you in relation to your use of
					...
					<div>
						...
						<p>
							These Terms will be governed by and construed in accordance with the laws of Ukraine, and
							you submit to the non-exclusive jurisdiction of Ukraine for the resolution of any disputes.
						</p>
					</div>
				</TCP>
			</Layout>
